...
package com.example.bloothcontroler.le;
    ...
    private final BluetoothGattCallback mGattCallback = new BluetoothGattCallback() {
        ...
        public void onConnectionStateChange(BluetoothGatt gatt, int status, int newState) {
            ...
            if (newState == BluetoothProfile.STATE_CONNECTED) {
                ...
                broadcastUpdate(intentAction);
                BluetoothDataIOServer.getInstance().close();
            }
        	}
        }
...
//            intent.putExtra(EXTRA_DATA, new String(data));
        ...
        BluetoothDataIOServer.getInstance().onDataRecv(data);
        sendBroadcast(intent);
    }
...
*/
    ...
    public void disconnect() {
        ...
        BluetoothDataIOServer.getInstance().disConnect();
    }
    ...
    public void setCharacteristicNotification(BluetoothGattCharacteristic characteristic,
        ...
        BluetoothDataIOServer.getInstance().init(mBluetoothGatt,characteristic);
