...
import com.example.bloothcontroler.ui.widget.entity.BaseFile
import com.example.bloothcontroler.ui.widget.entity.FileType
import com.example.bloothcontroler.ui.widget.entity.SortingTypes
import java.util.*
...
object PickerManager {
    ...
    fun addDocTypes(type:String) {
        if(type == "pdf")
        {
            val pdfs = arrayOf("pdf")
            fileTypes.add(FileType(FilePickerConst.PDF, pdfs, R.drawable.icon_file_unknown))
        }
        else if (type == "doc")
        {
            val docs = arrayOf("doc", "docx", "dot", "dotx")
            fileTypes.add(FileType(FilePickerConst.DOC, docs, R.drawable.icon_file_unknown))
        }
        else if(type=="ppt"){
            val ppts = arrayOf("ppt", "pptx")
            fileTypes.add(FileType(FilePickerConst.PPT, ppts, R.drawable.icon_file_unknown))
        } else if(type=="xls"){
            val xlss = arrayOf("xls", "xlsx")
            fileTypes.add(FileType(FilePickerConst.XLS, xlss, R.drawable.icon_file_unknown))
        }
        else if(type=="txt"){
